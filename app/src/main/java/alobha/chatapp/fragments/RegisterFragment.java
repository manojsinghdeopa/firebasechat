...
import alobha.chatapp.core.registration.RegisterContract;
import alobha.chatapp.core.registration.RegisterPresenter;
import alobha.chatapp.core.users.add.AddUserContract;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private void onRegister(View view) {
        ...
        {
            Toast.makeText(getActivity(), "Plaese Enter Email Address !", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(password))
        {
            Toast.makeText(getActivity(), "Plaese Enter Password !", Toast.LENGTH_SHORT).show();
        }
        else
        {
