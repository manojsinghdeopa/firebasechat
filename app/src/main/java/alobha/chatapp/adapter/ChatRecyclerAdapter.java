...
public class ChatRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        else if(mChats.get(position).senderUid!=FirebaseAuth.getInstance().getCurrentUser().getUid()
                &&mChats.get(position).message.equalsIgnoreCase(""))
        {
            if(mChats.get(position).getMapModel()!= null)
            {
    ...
    private void configureMyImageChatViewHolder(final MyImageChatViewHolder myImageChatViewHolder, int position) {
        ...
        else
        {
            ...
            Glide.with(myImageChatViewHolder.imgChatMessage.getContext()).load(chat.getFile().getUrl_file()).override(100, 100)
                    .fitCenter()
    ...
    private void configureOtherImageChatViewHolder(final OtherImageChatViewHolder otherImageChatViewHolder, int position) {
        ...
        else
        {
            ...
            Glide.with(otherImageChatViewHolder.imgChatMessage.getContext()).load(chat.getFile().getUrl_file()).override(100, 100)
                    .fitCenter()
